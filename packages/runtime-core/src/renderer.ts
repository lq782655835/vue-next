 ...
 *  TEXT = 0000000001;
    ...
    通过TEXT | CLASS来得到0000000011，而这个值可以表示他即有TEXT的特性，也有CLASS的特性

    拿到一个值FLAG的时候，想要判断他有没有TEXT特性，只需要FLAG & TEXT > 0就行
 */
  ...
  const patchElement = (
    ...
    // BlockTree
    // 一个 Block 其实就是一个 VNode，只不过它有特殊的属性(其中之一就是 dynamicChildren)
